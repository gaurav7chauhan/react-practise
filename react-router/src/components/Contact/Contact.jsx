        ...
        <div className="mt-8 overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-6 mr-2 bg-gray-800 sm:rounded-lg">
              <h1 className="text-3xl sm:text-4xl text-gray-100 font-extrabold tracking-tight">
                Get in touch:
              </h1>
            ...
            <form className="p-6 flex flex-col justify-center bg-gray-800 rounded-lg">
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className="w-100 mt-2 py-3 px-3 rounded-lg bg-gray-700 border border-gray-600 text-gray-100 font-semibold focus:border-orange-500 focus:outline-none placeholder-gray-400"
                />
              </div>
